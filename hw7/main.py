# Написать программу по импорту и экспорту телефонного
# справочника состоящий из N тысяч строк, содержащих информацию
# о неких пользователях.
...
# Программа должна быть модульной (как показывалось на уроке). Она
# должна уметь генерировать справочник и сохранять его в файл при
